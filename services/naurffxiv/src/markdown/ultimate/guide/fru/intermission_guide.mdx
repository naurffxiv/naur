...
After the <mark className="hl-ice">Absolute Zero</mark> cast, Shiva knocks everyone back from center and inflicts <Buff b="deep-freeze" /> on everyone, forcing you to wait for a brief scene.
...
The crystal covering the Usurper of Frost is called the Ice Veil, and it almost immediately begins casting <mark className="hl-ice">Endless Ice Age</mark>, the enrage for the phase.
...
Oddly, there’s no castbar for the big circles, but the narrow cones are called <mark className="hl-ice">Sinbound Blizzard</mark>.
...
After the third wave, the targeted players will be hit by a series of three <mark className="hl-cast">Hiemal Ray</mark>, small circular AoEs leaving behind puddles that inflict a DoT.
...
If all four survive while the Crystals of Light die, they will begin channeling <mark className="hl-dark">dark</mark> energy into Gaia and the Ice Veil.
...
In order to use it safely, all four Crystals of Darkness must first be given a <Buff b="vulnerability-down" /> from <mark className="hl-ice">Sinbound Blizzard</mark>.
...
Gaia’s channeling will complete successfully, and near the end of the <mark className="hl-ice">Endless Ice Age</mark> cast, Gaia will do her enormous hammer slam from E12N and remove a full half of the Ice Veil’s health bar.
