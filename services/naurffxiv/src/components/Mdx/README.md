...
```mdx
<Banner src="/images/ultimates/kefka/kefka-banner.webp" alt="Dancing Mad (Ultimate)" />
```
...
<Details title="Merry-Go-Round — Show Raidplan" href="https://docs.google.com/...">
  <iframe src="https://docs.google.com/..." width="100%" height="720" allowFullScreen />
</Details>

{/* Dropdown with external link + fullscreen button (for sites without a built-in fullscreen, e.g. raidplan.io) */}
<Details title="Phase 2 — Show Raidplan" href="https://raidplan.io/plan/..." fullscreen>
  <iframe src="https://raidplan.io/plan/..." width="100%" height="720" allowFullScreen />
</Details>
```
