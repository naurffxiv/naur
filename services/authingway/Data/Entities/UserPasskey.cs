...
/// <summary>
/// Represents a passkey credential associated with a user, using a GUID as the user identifier.
/// </summary>
public class UserPasskey : IdentityUserPasskey<Guid>, IEntityTypeConfiguration<UserPasskey>
{
    /// <inheritdoc/>
