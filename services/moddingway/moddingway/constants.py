...
MAX_APPEAL_REASON_LENGTH = 1024
MAX_STRIKE_REASON_LENGTH = 300
MAX_SEND_MESSAGE_LENGTH = 250
MAX_SLOWMODE_INTERVAL = 21600  # 6 hours in seconds
PERMANENT_BAN_STRIKE_THRESHOLD = 15

MESSAGE_LINK_PREFIX = "https://discord.com/channels/"

MAX_CHAR_LIMIT = 800
TRUNCATE_OFFSET = 3

ANNOUNCEMENT_REV_LIMIT = 3
