...
3. **Install Dependencies**: Run `make install` to create a virtual environment and install all dependencies.
...
- `make install` - Creates a virtual environment (`venv`) and installs all dependencies. **Run this first.**
